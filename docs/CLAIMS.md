...
| A final dimension-11 package manifest binds the accepted exact witness and all certificate trust anchors | Verified and published | Manifest SHA-256 `1a1f02f07f345129eb1541f30c38cedab2f141af429837d9dce6da41af6c6086`; release-mode replay; immutable GitHub release |
...
| The exact certificate proves `tau_11 <= 868` | Verified and published | Both verifiers pass and `docs/THEOREM_BRIDGE.md` derives the integer bound |
| The certificate is compact and commodity-verifiable | Verified and published | 14,565,324 compressed bytes; 907.16 seconds; 187,596,800 bytes maximum RSS |
| The public archive contains the exact immutable GitHub release files | Verified | GitHub release `386719977`; Zenodo record `22699475`; independent SHA-256 download verification |
...
The theorem, immutable public release, and byte-verified archive binding are
complete.
